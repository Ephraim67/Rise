(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2888],
  {
              ...
              if ("undefined" != typeof window)
                try {
                  localStorage.setItem(
                    t,
                    JSON.stringify(c(c({}, e), {}, { timestamp: f() }))
                  );
                } catch (t) {}
            },
          };
    ...
    83276: function (t, e, r) {
                      ...
                      function (r) {
                        for (;;)
                          switch ((r.prev = r.next)) {
                            case 0:
                              for (
                                r.prev = 0, u = Array((a = l.length)), i = 0;
                                i < a;
                                i++
                              )
                                u[i] = l[i];
                              return (
                                e.debug("adapter_".concat(n), { args: u }),
                                (c = t[n]),
                                (r.next = 6),
                                c.apply(void 0, u)
                              );
                      ...
                      for (;;)
                        switch ((r.prev = r.next)) {
                          ...
                          case 7:
                            (r.prev = 7),
                              (r.t0 = r.catch(0)),
                              e.error("".concat(E(n), "_EVENT_ERROR"), r.t0);
                          case 10:
                          case "end":
                            return r.stop();
                        }
      ...
      var v = (function (t) {
        ...
        function r() {
          ...
          return (
            ...
            (0, i.default)((0, u.default)(t), "name", "OAuthCallbackError"),
            t
          );
        }
      ...
      var y = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "AccountNotLinkedError"),
            t
          );
        }
        return (0, s.default)(r);
      ...
      var g = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "MissingAPIRouteError"),
            (0, i.default)(
              (0, u.default)(t),
              "code",
      ...
      var b = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "MissingSecretError"),
            (0, i.default)((0, u.default)(t), "code", "NO_SECRET"),
            t
          );
        }
        return (0, s.default)(r);
      ...
      var x = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "MissingAuthorizeError"),
            (0, i.default)(
              (0, u.default)(t),
              "code",
      ...
      var w = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "MissingAdapterError"),
            (0, i.default)(
              (0, u.default)(t),
              "code",
      ...
      var O = (function (t) {
        ...
        function r() {
          ...
          return (
            (t = e.call.apply(e, [this].concat(o))),
            (0, i.default)((0, u.default)(t), "name", "InvalidCallbackUrl"),
            (0, i.default)(
              (0, u.default)(t),
              "code",
    ...
    33299: function (t, e, r) {
      ...
      (e.SessionContext = void 0),
        (e.SessionProvider = function (t) {
                    ...
                    function (t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          ...
                          case 12:
                            return (
                              (j._lastSync = (0, x.now)()), (t.next = 15), R()
                            );
                          case 15:
          ...
          return (0, w.jsx)(L.Provider, { value: U, children: i });
        }),
        (e.getCsrfToken = M),
        (e.getProviders = U),
        (e.getSession = R),
        (e.signIn = function (t, e, r) {
      ...
      var j = {
          ...
          basePathServer: (0, b.default)(
            null !== (u = c.env.NEXTAUTH_URL_INTERNAL) && void 0 !== u
              ? u
              : c.env.NEXTAUTH_URL
          ).path,
          _lastSync: 0,
        ...
        P = (0, x.BroadcastChannel)(),
        k = (0, g.proxyLogger)(g.default, j.basePath),
        L =
          null === (i = y.createContext) || void 0 === i
            ? void 0
            : i.call(y, void 0);
      function R(t) {
          ...
          p.default.mark(function t(e) {
            ...
            return p.default.wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), (0, x.fetchData)("session", j, k, e);
                  case 2:
                    return (
                      (n = t.sent),
                      (null === (r = null == e ? void 0 : e.broadcast) ||
                        void 0 === r ||
                        r) &&
                        P.post({
                          event: "session",
          ...
          p.default.mark(function t(e) {
            ...
            return p.default.wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), (0, x.fetchData)("csrf", j, k, e);
                  case 2:
                    return (
                      (r = t.sent),
                      t.abrupt("return", null == r ? void 0 : r.csrfToken)
                    );
                  case 4:
                  case "end":
                    return t.stop();
          ...
          p.default.mark(function t() {
            return p.default.wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), (0, x.fetchData)("providers", j, k);
                  case 2:
            ...
            return p.default.wrap(function (t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  ...
                  case 42:
                    if (
                      ((m = new URL(b.url).searchParams.get("error")), !g.ok)
                    ) {
                      t.next = 46;
                      break;
                    }
                    return (t.next = 46), j._getSession({ event: "storage" });
                  case 46:
                    return t.abrupt("return", {
                      error: m,
                      status: g.status,
                ...
                switch ((t.prev = t.next)) {
                  ...
                  case 16:
                    if (
                      ...
                      !(
                        null === (r = null == e ? void 0 : e.redirect) ||
                        void 0 === r ||
                        r
                      ))
                    ) {
                  ...
                  case 23:
                    return (t.next = 25), j._getSession({ event: "storage" });
                  case 25:
    ...
    11940: function (t, e, r) {
      ...
      var n = r(85893);
      r(87133), r(5389), r(55889);
      var o = r(33299);
      function a(t) {
        let {
          Component: e,
          pageProps: { session: r, ...a },
        } = t;
      ...
      (t.exports = function (t, e) {
        ...
        if (null != r) {
          ...
          try {
            ...
            try {
              if (!c && null != r.return && ((u = r.return()), Object(u) !== u))
                return;
            } finally {
              if (s) throw o;
            }
      ...
      function o() {
        ...
        function d(t, r, n, o) {
          var a,
            u,
            c = Object.create(
              (r && r.prototype instanceof x ? r : x).prototype
            );
          return (
            i(c, "_invoke", {
              value:
                ...
                function (r, o) {
                  ...
                  for (a.method = r, a.arg = o; ; ) {
                    ...
                    var s = h(t, n, a);
                    if ("normal" === s.type) {
                      if (((u = a.done ? g : "suspendedYield"), s.arg === b))
                        continue;
                      return { value: s.arg, done: a.done };
                    }
                    "throw" === s.type &&
                      ((u = g), (a.method = "throw"), (a.arg = s.arg));
                  }
                }),
            }),
            c
                ...
                return new e(function (r, i) {
                  !(function r(o, a, i, c) {
                    ...
                    if ("throw" !== s.type) {
                      var l = s.arg,
                        f = l.value;
                      return f && "object" == n(f) && u.call(f, "__await")
        ...
        return (
          ...
          (w.displayName = p(_, f, "GeneratorFunction")),
          ...
          j(P.prototype),
          p(P.prototype, l, function () {
            return this;
          }),
          (r.AsyncIterator = P),
          (r.async = function (t, e, n, o, a) {
            void 0 === a && (a = Promise);
            var u = new P(d(t, e, n, o), a);
          ...
          (R.prototype = {
            ...
            finish: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t)
                  return this.complete(r.completion, r.afterLoc), L(r), b;
              }
            },
            catch: function (t) {
              for (var e = this.tryEntries.length - 1; e >= 0; --e) {
