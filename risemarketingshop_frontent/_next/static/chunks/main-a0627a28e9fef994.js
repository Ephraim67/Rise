(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [179],
  {
    ...
    67621: function (e, t, r) {
      ...
      async function Y(e) {
        ...
        if (
          ...
          let { initScriptLoader: e } = r(23773);
          e(o.scriptLoader);
        }
    ...
    88031: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(96514);
      let n = r(67621);
      (window.next = {
        version: n.version,
        get router() {
        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/page(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(.json)?[\\/#\\?]?$",
                originalSource: "/page/:path*",
              },
              {
                regexp:
