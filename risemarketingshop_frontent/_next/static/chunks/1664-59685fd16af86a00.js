  ...
  [1664],
  {
    ...
    81032: function (e, t, n) {
      ...
      let _ = r.default.forwardRef(function (e, t) {
        ...
        r.default.useEffect(() => {
          S && q && x && h(S, w, K, { locale: j }, { kind: U }, N);
        ...
        if ((0, f.isAbsoluteUrl)(K)) G.href = K;
          ...
          G.href =
            t ||
            (0, p.addBasePath)(
              (0, a.addLocale)(K, e, null == I ? void 0 : I.defaultLocale)
            );
        }
        return A
          ? r.default.cloneElement(l, G)
          : r.default.createElement("a", { ...k, ...G }, n);
      });
      ("function" == typeof t.default ||
        ("object" == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
